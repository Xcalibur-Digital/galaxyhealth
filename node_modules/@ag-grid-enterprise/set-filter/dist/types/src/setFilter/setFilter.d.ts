import type { BeanCollection, ComponentSelector, IAfterGuiAttachedParams, IDoesFilterPassParams, ISetFilter, SetFilterModel, SetFilterModelValue, SetFilterParams } from '@ag-grid-community/core';
import { AgPromise, ProvidedFilter } from '@ag-grid-community/core';
