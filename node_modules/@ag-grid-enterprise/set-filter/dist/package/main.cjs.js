...
function processDataPath(dataPath, treeData, groupAllowUnbalanced) {
  ...
  processedDataPath = processedDataPath.map((treeKey) => (0, import_core2._toStringOrNull)((0, import_core2._makeNull)(treeKey)));
  if (!treeData && groupAllowUnbalanced && processedDataPath.some((treeKey) => treeKey == null)) {
    if ((0, import_core2._last)(processedDataPath) == null) {
      return null;
    }
  ...
  extractUniqueValues(predicate, existingValues) {
    ...
    const addValue = (unformattedKey, value) => {
      ...
      if (!formattedKeys.has(formattedKey)) {
        ...
        let valueToAdd = (0, import_core3._makeNull)(value);
...
var SetValueModel = class {
  constructor(params) {
    this.localEventService = new import_core5.LocalEventService();
    ...
    if (treeDataOrGrouping && !keyComparator) {
      ...
      this.entryComparator = ([_aKey, aValue], [_bKey, bValue]) => (0, import_core5._defaultComparator)(aValue, bValue);
    } else {
      this.entryComparator = ([_aKey, aValue], [_bKey, bValue]) => keyComparator(aValue, bValue);
    }
    this.keyComparator = keyComparator ?? import_core5._defaultComparator;
    this.caseSensitive = !!caseSensitive;
    const getDataPath = gos.get("getDataPath");
    const groupAllowUnbalanced = gos.get("groupAllowUnbalanced");
    if ((0, import_core5._isClientSideRowModel)(gos)) {
  ...
  updateOnParamsChange(filterParams) {
    return new import_core5.AgPromise((resolve) => {
  ...
  refreshAfterAnyFilterChanged() {
    ...
    return import_core5.AgPromise.resolve(false);
  }
  isInitialised() {
    return this.initialised;
  }
  updateAllValues() {
    this.allValuesPromise = new import_core5.AgPromise((resolve) => {
  ...
  showAddCurrentSelectionToFilter() {
    return this.isInWindowsExcelMode() && (0, import_core5._exists)(this.miniFilterText) && this.miniFilterText.length > 0;
  }
    ...
    return this.allValuesPromise.then((keys) => {
      if (model == null) {
        ...
        model.forEach((unformattedKey) => {
          const formattedKey = this.caseFormat((0, import_core5._makeNull)(unformattedKey));
          const existingUnformattedKey = existingFormattedKeys.get(formattedKey);
  ...
  uniqueValues(values) {
    ...
    (values ?? []).forEach((value) => {
      const valueToUse = (0, import_core5._makeNull)(value);
  ...
  createTreeDataOrGroupingComparator() {
    return ([_aKey, aValue], [_bKey, bValue]) => {
      ...
      for (let i = 0; i < aValue.length; i++) {
        ...
        const diff = (0, import_core5._defaultComparator)(aValue[i], bValue[i]);
        if (diff !== 0) {
          return diff;
        }
      }
...
// enterprise-modules/set-filter/src/setFilter/setFilter.ts
var SetFilter = class extends import_core6.ProvidedFilter {
  constructor() {
    super("setFilter");
    this.eMiniFilter = import_core6.RefPlaceholder;
    this.eFilterLoading = import_core6.RefPlaceholder;
    this.eSetFilterList = import_core6.RefPlaceholder;
    this.eFilterNoMatches = import_core6.RefPlaceholder;
    ...
    this.updateSetFilterOnParamsChange = (newParams) => {
      ...
      const isGroupCol = newParams.column.getId().startsWith(import_core6.GROUP_AUTO_COLUMN_ID);
  ...
  getAgComponents() {
    return [import_core6.AgInputTextFieldSelector];
  }
  handleKeyDown(e) {
  ...
  getComponentForKeyEvent(e) {
    if (!this.eSetFilterList.contains((0, import_core6._getActiveDomElement)(this.gos)) || !this.virtualList) {
      return;
    }
  ...
  setModel(model) {
    if (model == null && this.valueModel?.getModel() == null) {
      ...
      return import_core6.AgPromise.resolve();
    }
  ...
  setModelAndRefresh(values) {
    ...
    }) : import_core6.AgPromise.resolve();
  }
  resetUiToDefaults() {
    this.setMiniFilter(null);
  ...
  areModelsEqual(a, b) {
    ...
    return a != null && b != null && (0, import_core6._areEqual)(a.values, b.values);
  }
  setParams(params) {
    this.applyExcelModeOptions(params);
  ...
  setValueFormatter(providedValueFormatter, keyCreator, treeList, isRefData) {
    ...
    if (!valueFormatter) {
      ...
      if (!isRefData) {
        valueFormatter = (params) => (0, import_core6._toStringOrNull)(params.value);
      }
    }
    this.valueFormatter = valueFormatter;
  }
  generateCreateKey(keyCreator, treeDataOrGrouping) {
    ...
    if (keyCreator) {
      return (value, node = null) => {
        ...
        return (0, import_core6._makeNull)(keyCreator(params));
      };
    }
    return (value) => (0, import_core6._makeNull)((0, import_core6._toStringOrNull)(value));
  }
  getFormattedValue(key) {
    ...
    if (this.noValueFormatterSupplied && (this.treeDataTreeList || this.groupingTreeList) && Array.isArray(value)) {
      value = (0, import_core6._last)(value);
    }
    ...
    return (formattedValue == null ? (0, import_core6._toStringOrNull)(value) : formattedValue) ?? this.translateForSetFilter("blanks");
  }
  ...
  setIsLoading(isLoading) {
    (0, import_core6._setDisplayed)(this.eFilterLoading, isLoading);
    if (!isLoading) {
  ...
  showOrHideResults() {
    ...
    (0, import_core6._setDisplayed)(this.eFilterNoMatches, hideResults);
    (0, import_core6._setDisplayed)(this.eSetFilterList, !hideResults);
  }
  resetMiniFilter() {
  ...
  onMiniFilterKeyDown(e) {
    const { excelMode, readOnly } = this.setFilterParams || {};
    if (e.key === import_core6.KeyCode.ENTER && !excelMode && !readOnly) {
...
var SetFloatingFilterComp = class extends import_core8.Component {
  constructor() {
    super(
      /* html */
      `
      ...
      [import_core8.AgInputTextFieldSelector]
    );
    this.eFloatingFilterText = import_core8.RefPlaceholder;
...
var SetFilterCoreModule = (0, import_core9._defineModule)({
  version: VERSION,
  moduleName: `${import_core9.ModuleNames.SetFilterModule}-core`,
  userComponents: [{ name: "agSetColumnFilter", classImp: SetFilter }],
  dependantModules: [import_core10.EnterpriseCoreModule, import_core9._ColumnFilterModule]
});
var SetFloatingFilterModule = (0, import_core9._defineModule)({
  version: VERSION,
  ...
  dependantModules: [SetFilterCoreModule, import_core9._FloatingFilterModule]
});
var SetFilterModule = (0, import_core9._defineModule)({
  version: VERSION,
  moduleName: import_core9.ModuleNames.SetFilterModule,
